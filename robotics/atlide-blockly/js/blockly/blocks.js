...
Blockly.Blocks['cozmo_on_start'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/atl-logo.jpeg", 15, 15, { alt: "*", flipRtl: "FALSE" }))
...
Blockly.Blocks['atl_logo'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/Blockly-logo.png", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("+")
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/Thymio01.jpg", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("+")
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/Cozmo01.jpg", 60, 60, { alt: "*", flipRtl: "FALSE" }))
        .appendField("=")
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/Like2.jpeg", 60, 60, { alt: "*", flipRtl: "FALSE" }));
    this.appendStatementInput("NAME")
        .setCheck(null)
        .appendField(new Blockly.FieldImage("https://atl-ux.s3.eu-central-1.amazonaws.com/media/atl-logo.jpeg", 100, 100, { alt: "*", flipRtl: "FALSE" }));
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(135);
